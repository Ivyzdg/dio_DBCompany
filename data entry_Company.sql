...
select Bdate, Address from Employee
	where Fname = 'John' and Miniti = 'B' and Lname = 'Smith';  
    
-- recuperando dpto específicio
select * from departament where Dname = 'Research';

-- recuperando as pessoas e seus endereços que trabalham no dpto 'Research'
...
-- retirando a ambiguidade atraves do alias ao AS Statement
